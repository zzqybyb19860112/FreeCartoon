package com.ybyb.zzq.freecartoon.ui.cartoon.girl;
...
public class GirlCartoonActivity extends BaseActivity<CartoonPresenter> implements CartoonContract.View {
    ...
    public static void start(Context context, String type) {
        Intent intent = new Intent(context, GirlCartoonActivity.class);
    ...
    private List<CartoonOverView> queryFromLocal(int start, int end) {
        ...
        CartoonData abc = data.getCartoonList().get(2).getData();
        if (abc!=null){
    ...
    protected int getContentViewId() {
        return R.layout.activity_girl_cartoon;
    }
    ...
    public void queryDataListOk(final CartoonData result) {
        ...
        final Cartoon cartoon = dataList.get(2);
