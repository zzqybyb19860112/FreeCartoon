package com.ybyb.zzq.freecartoon.ui.cartoon.child;
...
public class ChildCartoonActivity extends BaseActivity<CartoonPresenter> implements CartoonContract.View {
    ...
    /**
     * 启动ChildCartoonActivity
     */
    public static void start(Context context, String type) {
        Intent intent = new Intent(context, ChildCartoonActivity.class);
    ...
    protected int getContentViewId() {
        return R.layout.activity_child_cartoon;
    }
    ...
    private List<CartoonOverView> queryFromLocal(int start, int end) {
        ...
        CartoonData abc = data.getCartoonList().get(0).getData();
        if (abc!=null){
    ...
    public void queryDataListOk(final CartoonData result) {
        ...
        final Cartoon cartoon = dataList.get(0);
